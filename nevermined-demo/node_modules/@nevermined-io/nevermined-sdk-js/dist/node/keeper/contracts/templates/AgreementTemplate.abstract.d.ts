...
export declare abstract class AgreementTemplate extends ContractBase {
    ...
    abstract getAgreementIdsFromDDO(agreementId: string, ddo: DDO, assetRewards: AssetRewards, consumer: string, from?: string): Promise<string[]>;
    abstract createAgreementFromDDO(agreementId: string, ddo: DDO, assetRewards: AssetRewards, consumer: string, from?: string): Promise<boolean>;
    ...
    getAgreementStatus(agreementId: string): Promise<AgreementConditionsStatus | false>;
