...
class Dispenser extends ContractBase_1.default {
    static getInstance(config) {
        return __awaiter(this, void 0, void 0, function* () {
            const dispenser = new Dispenser('Dispenser', true);
            yield dispenser.init(config);
            return dispenser;
        });
    }
    requestTokens(amount, receiverAddress) {
        return __awaiter(this, void 0, void 0, function* () {
